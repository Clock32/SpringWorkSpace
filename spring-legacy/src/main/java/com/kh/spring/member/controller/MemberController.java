...
public class MemberController {
	...
	/*
	 * Spring DI(Dependenct Injection)
	 * 의존성 주입
	 * 어플리케이션을 구성하는 객체를 개발자가 직접 생성하는게 아닌, 스프링이 생성한 객체(bean)을 주입받아서 생성하는 방식
	 * new연산자를 직접사용하지 않고 Autowird 어노테이션을 통해 주입받는다.
	 * 
	 * 
	 * */
...
//	}
	 ...
	 * 
	 * */
	public String login(@RequestParam(value="userId" , defaultValue="hmh")
			String userId
			) {
...
//	}
	 ...
	 * - 요청시 전달한 name속성과 일치하는 vo클래스 필드의 setter메서드를 호출하여 데이터를 바인딩한다
